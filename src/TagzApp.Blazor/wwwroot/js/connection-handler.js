    ...
    if (window.Blazor) {
        ...
        window.Blazor.addEventListener('reconnecting', () => {
            ...
            if (connectionHandler) {
                connectionHandler.invokeMethodAsync('OnConnectionStateChanged', 'connecting', 1);
            }
        });
        ...
        window.Blazor.addEventListener('reconnected', () => {
            ...
            if (connectionHandler) {
                connectionHandler.invokeMethodAsync('OnConnectionStateChanged', 'connected');
            }
        });
        ...
        window.Blazor.addEventListener('disconnected', () => {
            ...
            if (connectionHandler) {
                connectionHandler.invokeMethodAsync('OnConnectionStateChanged', 'disconnected');
            }
        });
    }
